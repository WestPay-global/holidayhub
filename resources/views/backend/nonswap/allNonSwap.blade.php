...
@section('title')Reserved Properties @endsection
        ...
        <div class="row d-none">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">{{ucFirst($status)}} Reserved Properties</h4>
                </div>
            </div>
        </div>
        <!-- start page title -->
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript: void(0);">Reserved Properties</a></li>
                        </ol>
                    </div>
                    <h4 class="page-title">{{ucFirst($status)}} Reserved Properties</h4>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted font-13 mb-4">
                            This shows the list of Reserved Properties.
                        </p>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-space-between align-items-center">
                                                        ...
                                                        <a
                                                        href="{{ route('singleNonSwap', $item->id) }}"
