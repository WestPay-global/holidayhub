        ...
        <div class="row d-none">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">{{ucFirst($status)}} List Offers</h4>
                </div>
            </div>
        </div>
        <!-- start page title -->
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript: void(0);">List Offers</a></li>
                        </ol>
                    </div>
                    <h4 class="page-title">{{ucFirst($status)}} List Offers</h4>
                </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="header-title">Exchange Offers</h4>
                        <p class="text-muted font-13 mb-4">
                            This shows the list of List Offers.
                        </p>
                                        ...
                                        @foreach ($listOffers as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($item->owner->profile_picture)
                                                        <img src="{{ $item->owner->profile_picture }}" alt="Profile Picture" style="width: 25px; height: 25px; border-radius: 5px;">
                                                    @else
                                                ...
                                                <td>
                                                    ...
                                                    @if ($item->seeker->profile_picture)
                                                        <img src="{{ $item->owner->profile_picture }}" alt="Profile Picture" style="width: 25px; height: 25px; border-radius: 5px;">
                                                    @else
                                                        <div style="font-size: 24px; text-align:center;"><i class="fa fa-user-circle-o"></i></div>
                                                    @endif
                                                    <h5>{{ $item?->seeker?->name ? $item->seeker->name : 'N/A' }}</h5>
                                                </td>

                                                <td>{{ $item->exchange_type }}</td>

                                                <td>{{ $item->list_type == 'homeswap' ? 'Swap' : 'Reservation' }}</td>

                                                <td>{{ $item->list_type == 'homeswap' ? $item->homeswaplist->place_address : $item->nonswaplist->place_address }}</td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-space-between align-items-center">
                                                        ...
                                                        <a
                                                        href="{{ route('singleOffer', $item->id) }}"
